        ...
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                <a class="navbar-brand" href="index.php">
                    <img alt="Famintoo" height="30" src="img/rotaSimples.png" width="30" >
                </a>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu bg-light " style="background-color: black;">
                            <li><a class=" bg-light" style="background-color: #f60;" href="./maps/index.php"><font color="#fff">Lançamento de Entregas</font></a></li>
                        </ul>
                    </li>
